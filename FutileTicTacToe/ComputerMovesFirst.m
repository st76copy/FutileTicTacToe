...
//            NSLog(@"third move noCenter:%d  center:%d  noBoth:%d, humCenter: %d", compHasCornersNoHumanCenter, compHasCornersHumanHasCenter, compDoesNotHaveBothGoldenCorners, compHasCornersHumanHasCenter);
